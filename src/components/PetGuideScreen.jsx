...
import { GiDragonHead, GiWolfHead, GiEagleHead, GiDiamonds, GiCoins, GiTreasureMap } from "react-icons/gi";
  ...
  const petTiers = [
    {
      ...
      description: 'Maximize your efficiency with minimal investment. Perfect for F2P and low-spend players.',
    ...
    },
    {
      ...
      description: 'Optimal balance between cost and performance. Great value for moderate spenders.',
    ...
    },
    {
      ...
      description: 'Top-tier pets for serious competitors. Maximum power for those who want the best.',
      ...
      pets: [
        ...
        },
        {
          ...
          description: "Ancient griffin with unmatched speed and aerial dominance."
        }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white font-general overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-300 via-blue-300 to-yellow-300">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-xl font-circular-web text-blue-50 mb-8 max-w-2xl mx-auto drop-shadow-lg">
            Complete guide to pet strategies across all spending levels - from F2P to premium builds
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 border border-white/30">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white font-zentry font-bold">Low Spend</span>
              </div>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 border border-white/30">
              <div className="flex items-center gap-2">
                <GiWolfHead className="text-white text-xl" />
                <span className="text-white font-zentry font-bold">Mid Spend</span>
              </div>
            </div>
            <div className="bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 border border-white/30">
              <div className="flex items-center gap-2">
                <GiDragonHead className="text-white text-xl" />
                <span className="text-white font-zentry font-bold">High Spend</span>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto p-6 bg-black">
        ...
        <div className="space-y-8">
          {petTiers.map((tier) => (
            <div key={tier.id} className={`bg-gradient-to-r from-gray-900/90 via-gray-800/90 to-gray-900/90 rounded-3xl border border-gray-700 backdrop-blur-sm overflow-hidden shadow-xl`}>
              {/* Section Header */}
              <button
              ...
              >
                <div className="flex items-center gap-6 text-left">
                  <div className={`p-4 rounded-2xl backdrop-blur-sm ${tier.id === 'low-spend' ? 'bg-green-500/20' : tier.id === 'mid-spend' ? 'bg-blue-500/20' : 'bg-purple-500/20'}`}>
                    {tier.icon}
                  </div>
                  <div>
                      ...
                      {tier.pets.map((pet, index) => (
                        ...
                        >
                          <div className="text-center mb-4">
                            ...
                            <span className={`px-3 py-1 rounded-full text-sm font-circular-web font-semibold ${
                              pet.cost === 'Free' ? 'bg-green-900/50 text-green-300 border border-green-700' :
                              pet.cost === 'Low' ? 'bg-green-900/50 text-green-300 border border-green-700' :
                              pet.cost === 'Medium' ? 'bg-blue-900/50 text-blue-300 border border-blue-700' :
                          ...
                          <div className="space-y-3">
                            <div className="p-3 bg-yellow-900/30 rounded-lg border border-yellow-700">
                              <span className="text-yellow-300 font-circular-web font-bold text-sm uppercase tracking-wider block mb-1">Stats:</span>
                              <span className="text-yellow-100 font-circular-web font-semibold text-sm">{pet.stats}</span>
                            </div>
        ...
        <section className="mt-20 relative py-20 bg-black rounded-3xl text-white overflow-hidden">
          ...
          <div className="relative z-10 text-center px-8">
            ...
            <p className="text-xl font-circular-web text-white/80 mb-12 max-w-2xl mx-auto">
              Choose your spending strategy and build the perfect pet collection for your playstyle.
            </p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {selectedTier.pets.map((pet, index) => (
                  <div key={index} className="bg-gray-800 rounded-xl p-4">
                    ...
                    />
                    <h4 className="text-lg font-zentry font-black text-white mb-2">{pet.name}</h4>
